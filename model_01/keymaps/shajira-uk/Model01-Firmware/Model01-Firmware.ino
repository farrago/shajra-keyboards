...
KEYMAPS
    ( [BASE] = KEYMAP_STACKED
        // left hand
        ( Key_CapsLock,    Key_1, Key_2, Key_3, Key_4, Key_5, Key_NonUsBackslashAndPipe 
        ...
        , Key_Equals,     Key_Y, Key_U, Key_I,     Key_O,      Key_P,         Key_NonUsPound
    ...
    , [FUNCTION] = KEYMAP_STACKED
        // left hand
        ( System_Hibernate,     Key_F1,                     Key_F2,               Key_F3,               Key_F4,                Key_F5,            Key_LEDEffectNext
